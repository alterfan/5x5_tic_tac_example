...
import { aiMakeMove as AI } from './aiMakeMoveA.js'
import Cell from './Cell.js'
import { Dom, Transform, switchTurn, getStateResult, getChar, getBoardCopy, checkRow, isBetter } from './Helpers.js'
export default class Board extends Phaser.GameObjects.Container {
	constructor(scene, x, y) {
		super(scene)
		this.scene = scene
		this.AI = new AI(arguments)
	...
	makeMove(cell) {
		if (this.state.whoseTurn == 'x') {
			...
			var move = this.AI.makeMove(this.matrix, this.last_move)
			this.draw(move)
